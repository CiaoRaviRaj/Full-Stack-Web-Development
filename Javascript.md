...
* DataType
    * String
        ...
        * comparing string
            ...
            * String.fromCodePoint(i); //to create str
...
* Functions
    ...
    * Methods
        ...
        * Function.bind
            ...
            * It create copy of function as fucn that invoke later.
            * now we can use
...
* objects
    ...
    * Object prototypes
        ...
        • Delegation: it is programming patterns In which an object can perform task itself or ask other object to perform
        * tasks
        • Ex:
    ...
    * Classes
        ...
        * conts object = new Professor ('name', 'science ');
    ...
    * Json
        ...
        • Array as JSON
        • API fatching
        • requestedURL, Request , fetch () ,response , json
        • appendChild
        • parse(), stringify()
